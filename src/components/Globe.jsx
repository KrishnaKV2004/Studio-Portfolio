...
const GLOBE_CONFIG = {
  ...
  markers: [
    ...
    // India Markers
    { location: [28.6139, 77.2090], size: 0.12 }, // New Delhi
    ...
    { location: [34.6937, 135.5022], size: 0.1 },  // Osaka

    // ----- South Korea -----
    { location: [37.5665, 126.9780], size: 0.12 }, // Seoul
    { location: [35.1796, 129.0756], size: 0.1 },  // Busan
